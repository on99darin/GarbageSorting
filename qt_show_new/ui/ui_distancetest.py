...
class Ui_Dialog_lx(object):
    def setupUi(self, Dialog_lx):
        ...
        self.wgt_player.setGeometry(QtCore.QRect(40, 10, 321, 351))
        self.wgt_player.setObjectName("wgt_player")
        self.label_2 = QtWidgets.QLabel(Dialog_lx)
        self.label_2.setGeometry(QtCore.QRect(360, 0, 551, 361))
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")

        self.retranslateUi(Dialog_lx)
        self.getdata.clicked.connect(Dialog_lx.getdatastart)
        self.stop.clicked.connect(Dialog_lx.timerstop)
        self.listWidget.clicked['QModelIndex'].connect(Dialog_lx.getdatastart)
